...
class SistemaNotaFiscal:
    ...
    def criar_tela_login(self):
        """Cria a tela de login com design moderno"""
        # Limpar a janela
        for widget in self.root.winfo_children():
            widget.destroy()
        
        # Configurar a janela para centralizar
        ...
        # Título
        titulo = tk.Label(center_frame, text="SISTEMA DE NOTA FISCAL", 
                         font=("Arial", 18, "bold"), bg="#ffffff", fg="#333333")
        titulo.pack(pady=(0, 10))
        
        subtitulo = tk.Label(center_frame, text="Padaria Quero Mais", 
        ...
        # Entry com bordas arredondadas
        self.entry_usuario = tk.Entry(form_frame, font=("Arial", 12), width=25,
        ...
        self.entry_senha = tk.Entry(form_frame, font=("Arial", 12), width=25, show="*",
                                   bg="#f5f5f5", fg="#333333", insertbackground="#333333",
                                   relief="flat", bd=0)
        self.entry_senha.pack(pady=(0, 25), ipady=8)
        
        # Botão de login com design moderno (inspirado na imagem)
        btn_frame = tk.Frame(form_frame, bg="#4CAF50", relief="flat", bd=0)
        btn_frame.pack(pady=10)
        
        btn_login = tk.Button(btn_frame, text="ENTRAR", 
                             font=("Arial", 12, "bold"), 
                             bg="#4CAF50", fg="white",
                             width=20, height=2,
                             relief="flat", bd=0,
        ...
        tk.Label(info_frame, text="Usuário: admin1 | Senha: admin123", 
                font=("Arial", 9), bg="#ffffff", fg="#999999").pack()
